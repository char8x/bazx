...
export function filtered(
  ...
  return (exec) =>
    function filteredExec(cmd, options) {
      if (!predicate(cmd)) {
...
export const swapStdoutStderr: BazxMiddleware = (exec) => (cmd, options = {}) =>
  exec(cmd, {
    ...options,
...
export const interceptCurl: BazxMiddleware =
